...
export interface ApiCategorieAssuranceCategorieAssurance
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::categorie-assurance.categorie-assurance'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
    typeClient: Schema.Attribute.Relation<
      'manyToOne',
      'api::type-client.type-client'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiIntentionSeoIntentionSeo
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::intention-seo.intention-seo'
    > &
      Schema.Attribute.Private;
...
export interface ApiPageSeoPageSeo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    motClePrincipal: Schema.Attribute.String;
    permalink: Schema.Attribute.String & Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'seo.meta', false>;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    sousCategorie: Schema.Attribute.Relation<
      'manyToOne',
      'api::intention-seo.intention-seo'
    >;
...
export interface ApiTypeClientTypeClient extends Struct.CollectionTypeSchema {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::categorie-assurance.categorie-assurance': ApiCategorieAssuranceCategorieAssurance;
      'api::category.category': ApiCategoryCategory;
      'api::global.global': ApiGlobalGlobal;
      'api::intention-seo.intention-seo': ApiIntentionSeoIntentionSeo;
      'api::metier.metier': ApiMetierMetier;
      'api::page-seo.page-seo': ApiPageSeoPageSeo;
      'api::testimonial.testimonial': ApiTestimonialTestimonial;
      'api::type-client.type-client': ApiTypeClientTypeClient;
